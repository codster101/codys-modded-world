...
public class CityHallBlock extends AbstractChestBlock<CityHallBlockEntity> implements Waterloggable {
    public static final MapCodec<CityHallBlock> CODEC = createCodec(CityHallBlock::new);
    public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;
    public static final BooleanProperty WATERLOGGED = Properties.WATERLOGGED;
    protected static final VoxelShape SHAPE = Block.createCuboidShape(1.0, 0.0, 1.0, 15.0, 14.0, 15.0);
    private static final Text CONTAINER_NAME = Text.translatable("container.cityhall");

    @Override
    public MapCodec<CityHallBlock> getCodec() {
        return CODEC;
    }

    public CityHallBlock(AbstractBlock.Settings settings) {
        super(settings, () -> ModBlockEntities.CITY_HALL_BLOCK_ENTITY);
