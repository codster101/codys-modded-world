...
public class ModScreenHandlers {
    public static final ScreenHandlerType<CityHallScreenHandler> CITY_HALL_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(CodysModdedWorld.MOD_ID,
                    "city_hall_screen_handler"), new ScreenHandlerType<>(CityHallScreenHandler::createGeneric9x3,
                    FeatureFlags.VANILLA_FEATURES));

    public static void registerScreenHandlers() {
        CodysModdedWorld.LOGGER.info("Registering screen handlers for: " + CodysModdedWorld.MOD_ID);
    }
}
